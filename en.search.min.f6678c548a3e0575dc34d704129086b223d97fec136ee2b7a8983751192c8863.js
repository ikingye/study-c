...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.f185dcc21167d97d5a158a61fedd23045e31d95a4607e3710a85c0afbc608aec.js',function(){input.required=false;search();});}
